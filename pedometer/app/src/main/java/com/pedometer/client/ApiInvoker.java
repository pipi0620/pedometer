        ...
        if ("GET".equals(method)) {
            ...
            if (formParamStr != null) {
                ...
                if (body instanceof HttpEntity) {
                    ...
                    request = new PostRequest(url, headers, null, new StringEntity(serialize(body), ContentType.APPLICATION_JSON), stringRequest, errorListener);
                }
            } else {
            ...
            if (formParamStr != null) {
                ...
                if (body instanceof HttpEntity) {
                    ...
                    request = new PutRequest(url, headers, null, new StringEntity(serialize(body), ContentType.APPLICATION_JSON), stringRequest, errorListener);
                }
            } else {
            ...
            if (formParamStr != null) {
                ...
                if (body instanceof HttpEntity) {
                    ...
                    request = new DeleteRequest(url, headers, null, new StringEntity(serialize(body), ContentType.APPLICATION_JSON), stringRequest, errorListener);
                }
            } else {
            ...
            if (formParamStr != null) {
                ...
                if (body instanceof HttpEntity) {
                    ...
                    request = new PatchRequest(url, headers, null, new StringEntity(serialize(body), ContentType.APPLICATION_JSON), stringRequest, errorListener);
                }
            } else {
